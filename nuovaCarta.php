...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/nuova_carta_style.css">
        <title>Nuova Carta</title>
    ...
    <body>
        ...
        <h1 id='titoloPagina'>Nuova Carta</h1>

        <div id = "input">

            <form action="inserisci_nuova_carta_sql.php" method="POST" class = "loginForm" onsubmit="return validateAuthors()">
            <div class="riga">
            ...
            <div class="riga">
                <input type="text" class="elemento" id="isbn" name="isbn" minlength="17" maxlength="17" placeholder="Es. 565-24-53254-06-3" required>
            ...
            <input id="submit" type="submit" name="submit" value="Aggiungi Carta">
            </form>
        ...
        function removeAuthor(button) {
            ...
            function creaSelectScaffale()
            {
                ...
                xhttp.open("POST", "crea_select_scaffale_carta.php", true);
                xhttp.send();
            }
                ...
                for (let i = 0; i < authorRows.length; i++) {
                    ...
                    if (nome && cognome) {
                        ...
                        if (authors.includes(fullName)) {
                            Swal.fire({
                                icon: "error",
                                title: "Impossibile aggiungere la carta!",
                                text: "Impossibile aggiungere la carta! Ci sono degli autori con lo stesso nome e cognome."
                            });
                            return false;
                        }
